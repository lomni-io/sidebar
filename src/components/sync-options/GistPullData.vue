...
<!--    <div class="loading"></div>-->
    ...
    <div class="bottom-button-container">
      ...
      <button class="blue" @click="pullData" :disabled="!(mergedData && mergedData.hasChanges)">pull</button>
    </div>
      ...
      octokit.rest.users.getAuthenticated().then(() => {
        ...
        octokit.rest.gists.get({gist_id: storage.gistID}).then(res => {
          ...
          if (dataFile){
            ...
            this.mergedData = mergeData(remoteFrames, store.getters.frames, true)
          }else{
