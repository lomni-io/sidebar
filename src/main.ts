...
library.add(faEye, faEdit, faFloppyDisk, faTrash, faTv, faArrowUpRightFromSquare, faSquarePlus, faThumbtack, faPlusSquare, faXmark, faCopy, faBars, faObjectGroup, faObjectUngroup, faVideo, faMicrophone, faVolumeUp, faStar, faRotate, faClone, faCircleCheck, faStar)
