    ...
    test('test sort tags by cardinality', () => {
        ...
        const expected = [
            ...
            },
            {
                ...
                url: 'https://test2.ski.com/abc2',
                suggestedTags: [],
                favIconUrl: 'chrome-extension://undefined/_favicon/?pageUrl=https%3A%2F%2Ftest2.ski.com%2Fabc2&size=16',
                kind: 'web',
                domain: 'test2.ski.com',
                preProcessedTags: ['@ski', '@test2'],
                tags: ['#ski2023', '#24k'],
                ...
                tabs: [
                    {
                        ...
                        suggestedFrames: [
                            {
                                favIconUrl: "chrome-extension://undefined/_favicon/?pageUrl=https%3A%2F%2Ftest.ski.com%2FnotOpenedButHasTo&size=16",
                                preProcessedTags: ["@test","@ski"],
                                tags: ["#myTag"],
                                title: "title3",
                                url: "https://test.ski.com/notOpenedButHasTo",
